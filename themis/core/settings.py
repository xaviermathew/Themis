...
CELERY_TASK_ROUTING_KEY_DEFAULT = 'pd.T_default'

CELERY_TASK_QUEUE_CRAWL_FEED = 'T_crawl_feed'
CELERY_TASK_ROUTING_KEY_CRAWL_FEED = 'pd.T_crawl_feed'

CELERY_TASK_QUEUE_PROCESS_ARTICLE = 'T_process_article'
CELERY_TASK_ROUTING_KEY_PROCESS_ARTICLE = 'pd.T_process_article'

CELERY_TASK_QUEUE_CRAWL_TWITTER = 'T_crawl_twitter'
CELERY_TASK_ROUTING_KEY_CRAWL_TWITTER = 'pd.T_crawl_twitter'

CELERY_TASK_QUEUE_PROCESS_TWEET = 'T_process_tweet'
CELERY_TASK_ROUTING_KEY_PROCESS_TWEET = 'pd.T_process_tweet'
